package io.github.fatsquirrels.deuzumDesktop.visual.layout;
...
public class VerticalFlowLayout implements LayoutManager, java.io.Serializable{
 	...
 	* @see 	visual.layout.visual.panel.VerticalFlowLayout#setAlignment
 	* @since 	JDK1.1
 	*/
 	...
 	*       	and between the components and the borders
 	*       	of the <code>Container</code>
 	* @see 	visual.layout.visual.panel.VerticalFlowLayout#setHgap
 	* @since 	JDK1.1
 	*/
	public int getHgap() {
    	return hgap;
 	...
 	*       	and between the components and the borders
 	*       	of the <code>Container</code>
 	* @see 	visual.layout.visual.panel.VerticalFlowLayout#getHgap
 	* @since 	JDK1.1
 	*/
 	...
 	*       	and between the components and the borders
 	*       	of the <code>Container</code>
 	* @see 	visual.layout.visual.panel.VerticalFlowLayout#setVgap
 	* @since 	JDK1.1
 	*/
	public int getVgap() {
    	return vgap;
 	...
 	*       	and between the components and the borders
 	*       	of the <code>Container</code>
 	* @see 	visual.layout.visual.panel.VerticalFlowLayout#getVgap
 	*/
