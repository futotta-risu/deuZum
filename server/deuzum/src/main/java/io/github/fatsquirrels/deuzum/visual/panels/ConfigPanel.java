...
public class ConfigPanel extends JPanel{
	...
	public ConfigPanel() {
		...
		spinner_Port.setModel(new SpinnerNumberModel(Integer.parseInt((String)ServerHandler.properties.get("server.port")), 0, 65535, 1));
		...
		txf_ServerName.setText((String) ServerHandler.properties.get("server.name"));
		...
		slider_ConTimeOut.setValue(Integer.parseInt((String)ServerHandler.properties.get("server.conexionTimeOut")));
		...
		btn_Save.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ServerHandler.updateProperty("server.conexionTimeOut",String.valueOf(slider_ConTimeOut.getValue()) );
				ServerHandler.updateProperty("server.port",spinner_Port.getValue().toString());
				ServerHandler.updateProperty("server.name",txf_ServerName.getText());
		
				ServerHandler.storeProperties();
			}
		});
