...
public class ServerUserFunctionality {
	 ...
	 * @param data Array que contiene los datos del usuario (Usuario, ContraseÃ±a, Pregunta de Seguridad, Respuesta, Permisos)
	 */
	public static void updateUser(Connection connection, String userID, String[] data) {
		String[] columnNamesUsuarios = {"usuario","contraseÃ±a","preg_seguridad","resp_seguridad", "permisos"};
	...
	/**
	 * Genera una conexiÃ³n con el servidor SQL y ordena la informacion en un array para llamar a la funcion updateUserInf.
	 * @param data JSON que contiene informacion detallada de usuario.
	 * @see #updateUserInf
	 */
